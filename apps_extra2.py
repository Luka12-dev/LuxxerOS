...
class HabitTrackerApp(QMainWindow):
    """Track habits, record completion for days, show streaks."""
...
class RandomStoryApp(QMainWindow):
    """App that generates random short stories for fun & inspiration."""
    def __init__(self):
        super().__init__()
...
class TravelTipsApp(QMainWindow):
    """Generates random travel tips & ideas."""
...
class QRCodeGeneratorApp(QMainWindow):
    """Generate QR codes from text (requires qrcode lib for image generation)."""
    def __init__(self):
        super().__init__()
...
class ColorPaletteApp(QMainWindow):
    """Create and store color palettes."""
...
class RecipeBoxApp(QMainWindow):
    """Store recipes (title, ingredients, steps)."""
...
class BudgetTrackerApp(QMainWindow):
    """Simple expense tracker (categories, amount)."""
    ...
    def remove_item(self, item):
        """Remove selected expense on double click."""
...
class TerminalGamesApp(QMainWindow):
    """Several small terminal-style games: Guess Number and Hangman."""
    def __init__(self):
        super().__init__()
...
class AmbientSoundApp(QMainWindow):
    """Play ambient loop files (if multimedia available)."""
    def __init__(self):
        super().__init__()
...
class ScreenOrganizerApp(QMainWindow):
    """Provide simple tiling actions for MDI-style main windows.
       Provide tile horizontally/vertically or cascade."""
